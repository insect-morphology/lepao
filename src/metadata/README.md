 ...
 * [lepao.yml](lepao.yml)
     * Determines how your purl.obolibrary.org/obo/lepao/ redirects will be handled
     ...
     * Paste in the contents of [lepao.yml](lepao.yml)
 ...
 * [lepao.md](lepao.md)
     ...
     * Paste in the contents of [lepao.md](lepao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
