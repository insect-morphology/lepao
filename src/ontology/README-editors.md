These notes are for the EDITORS of lepao
...
Make sure you have an ID range in the [idranges file](lepao-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [lepao-edit.owl](lepao-edit.owl)

** DO NOT EDIT lepao.obo OR lepao.owl in the top level directory **

[../../lepao.owl](../../lepao.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/luis-gonzalez-m/lepao) for details.
 ...
 * [lepao-idranges.owl](lepao-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/lepao_terms.txt file
...
Note: the lepao_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as lepao.owl and lepao.obo and places
 ...
 * https://github.com/luis-gonzalez-m/lepao/releases
 * https://github.com/luis-gonzalez-m/lepao/releases/new
...
what is in the `owl:versionIRI` of the derived lepao.owl (`data-version` in
lepao.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/lepao.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/lepao/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/luis-gonzalez-m/lepao.svg?branch=master)](https://travis-ci.org/luis-gonzalez-m/lepao)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/luis-gonzalez-m](https://travis-ci.org/profile/luis-gonzalez-m)
 2. click the "Sync account" button
 3. Click the tick symbol next to lepao
